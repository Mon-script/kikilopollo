      ...
      <Table.Body className="divide-gray-25 divide-y">
        {dataArray.map((item, index) => (
          <Table.Row className="bg-white" key={index}>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="-mb-0.5 text-body-4 font-medium text-metal-600">{item.nombre_producto}</p>
                      <p className="-mb-0.5 text-body-4 font-medium text-metal-600">{item.id_producto}</p>
                      <span className="text-body-6 font-normal text-metal-500"></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Table.Cell>
              <p className="text-body-5 font-medium text-metal-500">Cantidad en U: {item.cantidad_producto}</p>
            </Table.Cell>
            <Table.Cell>
